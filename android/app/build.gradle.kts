...
android {
    namespace = "dk.parkingson.parkingson"
    compileSdk = 36
    ...
    defaultConfig {
        // Play Store application ID. May differ from `namespace` (the code
        // package), which stays dk.parkingson.parkingson.
        applicationId = "henrock.n0rby.parkingson"
